# NUSe0032202
###### \out\production\resources\view\Calendar.fxml
``` fxml
...
```
###### \src\main\java\seedu\address\logic\commands\SortAddress.java
``` java
...
```
###### \src\main\java\seedu\address\logic\parser\CopyCommandParser.java
``` java
...
```
###### \src\main\java\seedu\address\ui\CalendarTest.java
``` java
...
```
###### \src\main\resources\view\Calendar.fxml
``` fxml
<BorderPane fx:id="calendar" maxHeight="-Infinity" maxWidth="-Infinity" minHeight="-Infinity" minWidth="-Infinity" prefHeight="100.0" prefWidth="300.0" xmlns="http://javafx.com/javafx/8.0.111" xmlns:fx="http://javafx.com/fxml/1">
   <center>
      <GridPane BorderPane.alignment="CENTER">
...
```
###### \src\test\java\systemtests\SortCommandSystemTest.java
``` java
