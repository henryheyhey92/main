...
When user start up the application, it will prompt to the user to enter his name and password.
Wrong user name and password will not grant the user the access to the address book.
Correct input for both allows the user to access the addressbook.
Currently, the password is hardcoded into the application.
...
* * Passcode login enhance version
